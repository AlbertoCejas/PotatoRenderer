...
class ShapeRenderer
{
  public:
	...
	void rectangle(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4, const Color& col1, const Color& col2,
	               const Color& col3, const Color& col4);
